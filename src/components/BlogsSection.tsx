      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-card rounded-2xl shadow-lg overflow-hidden border">
            <div className="p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-foreground">Featured Video</h3>
        ...
        <div className="text-center animate-on-scroll">
          <div className="inline-flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" size="lg" className="group hover:scale-105 transition-all duration-300 hover:bg-red-50 hover:border-red-300">
              Subscribe to Channel
              <Play className="w-4 h-4 ml-2 group-hover:text-red-600 transition-colors duration-300" />
            </Button>
          </div>
        </div>
      </div>
