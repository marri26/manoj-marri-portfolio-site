  ...
  return (
    <section className="py-16 px-6" id="about">
      <div className="max-w-4xl mx-auto">
        <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-sm border animate-on-scroll card-hover">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed">
            ...
            <p className="text-center font-medium text-foreground animate-on-scroll">
